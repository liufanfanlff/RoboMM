...
# calvin
abs_datasets_dir = Path('/data/robotics/task_D_D/training')
data_path = '/data/new_calvin_D_1/training'
...
# metaworld
abs_datasets_dir = '/data/robotics/metaworld_uniview/'
...
# libero
lang_ann = []
abs_datasets_dir = Path('/data/robotics/libero_uniview_final')
...
# robocasa
lang_ann = []
abs_datasets_dir = '/data/robotics/robocasa_uniview'
json_path = os.path.join(abs_datasets_dir, "train_metaworld.json")
with open(json_path, 'r') as f:
    data = json.load(f)
for data_slice in data:
...
# rlbench
lang_ann = []
abs_datasets_dir = Path('data/robotics/RLbench/RT/train')
...
# colosseum
lang_ann = []
abs_datasets_dir = Path('data/data/robot-colsseum')
