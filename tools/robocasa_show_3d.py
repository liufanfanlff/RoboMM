...
if 1:
    ...
    def process_task(task, abs_datasets_dir):
        ...
        for demo_name in [tmp for tmp in os.listdir(data_dir) if '.zip' in tmp]:
            ...
            zip_file = "/data/robotics/robocasa_uniview/multi_stage_brewing_PrepareCoffee_2024-05-07/demo_14.zip"
...
if 0:
    ...
    for task in _task_list:
        ...
        for demo_name in [tmp for tmp in os.listdir(data_dir) if '.zip' in tmp]:
            zip_file = os.path.join(data_dir, demo_name)
            # zip_file = "/data/robotics/robocasa_uniview/single_stage_kitchen_drawer_CloseDrawer_2024-04-30/demo_1.zip"
            # print(zip_file)
