...
sys.path.append('/project/robotic/robosuite')
import robocasa
import robosuite_casa as robosuite
from zipfile import ZipFile

root_save = '/data/robotics/robocasa_uniview_tmp'
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset",
        type=str,
        default='/project/robotic/RoboUniview/third_party/robocasa/../../../../../data/robotics/robocasa/v0.1/single_stage/kitchen_doors/CloseDoubleDoor/2024-04-29/demo.hdf5',
    ...
    root = '/data/robotics/robocasa/v0.1'
