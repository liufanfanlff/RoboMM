export PATH=$PATH:/workspace/RoboFlamingo
export PYTHONPATH=$PYTHONPATH:/workspace/RoboFlamingo

source /software/anaconda3/bin/activate RoboFlamingo_yiyang
...
export DISPLAY=:99
#export PYTHONPATH=/workspace/RoboFlamingo
