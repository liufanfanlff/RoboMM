...
new_path = '/data/new_calvin_ABC_D_1/'


# sys.path.append('/project/robotic/RoboFlamingo/open_flamingo')
...
def generate_npz(dataset_path_env,data,clip_files,cam_config,ii):
    ...
    # img_clip.write_gif('/data/debug.gif', fps=30)
    del env
