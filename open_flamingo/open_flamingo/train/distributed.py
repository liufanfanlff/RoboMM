...
def init_distributed_device(args):
    ...
    if args.horovod:
        ...
        if "SLURM_PROCID" in os.environ:
            ...
            torch.distributed.init_process_group(
                backend=args.dist_backend, init_method=args.dist_url, timeout = timedelta(seconds=72000000),
            )
...
def init_distributed_device_with_ds(args):
    import deepspeed
    ...
    if args.horovod:
        ...
        if "SLURM_PROCID" in os.environ:
            ...
            deepspeed.init_distributed(
                dist_backend=args.dist_backend, init_method=args.dist_url, timeout = timedelta(seconds=72000000),
            )
            args.world_size = torch.distributed.get_world_size()
            args.rank = torch.distributed.get_rank()
        args.distributed = True
...
#  init_distributed(dist_backend=None,
